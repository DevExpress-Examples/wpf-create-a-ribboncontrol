...
Namespace RibbonControl_Ex
    ...
    Class MainWindow
        ...
        'Dim ribbonControl1 As RibbonControl
        ...
        Dim fmtText As FormattedText = Nothing
        ...
        Private Function CreateImage(ByVal fontFamily As FontFamily) As ImageSource
            ...
            Const HalfDimensionSize As Double = DimensionSize / 2.0R
            ...
            Dim verticalOffset As Double = (DimensionSize - fmtText.Baseline) / 2.0R
            c.DrawText(fmtText, New Point(HalfDimensionSize, verticalOffset))
            c.Close()

            Dim rtb As RenderTargetBitmap = New RenderTargetBitmap(CInt(Fix(DimensionSize)), CInt(Fix(DimensionSize)), 96, 96, PixelFormats.Pbgra32)
            rtb.Render(v)
            Return rtb
        End Function
        ...
        Dim isInvokePending As Boolean = False
        ...
        Protected Sub UpdateFormat()
            ...
            If (value Is DependencyProperty.UnsetValue) Then
                eFontSize.EditValue = Nothing
            Else
                eFontSize.EditValue = value
            End If
        End Sub
        ...
        Private Sub OptionsButton_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            CType(RibbonControl.ApplicationMenu, ApplicationMenuInfo).ClosePopup()
        End Sub
        ...
        Private Sub bAbout_ItemClick_1(ByVal sender As System.Object, ByVal e As DevExpress.Xpf.Bars.ItemClickEventArgs)
    ...
    Public Class FontSizes
        Public ReadOnly Property Items() As Double()
            Get
                Return New Double() {3.0, 4.0, 5.0, 6.0, 6.5, 7.0, 7.5, 8.0, 8.5, 9.0, 9.5, 10.0, _
                                     10.5, 11.0, 11.5, 12.0, 12.5, 13.0, 13.5, 14.0, 15.0, 16.0, _
                                     17.0, 18.0, 19.0, 20.0, 22.0, 24.0, 26.0, 28.0, 30.0, 32.0, _
                                     34.0, 36.0, 38.0, 40.0, 44.0, 48.0, 52.0, 56.0, 60.0, 64.0, _
                                     68.0, 72.0, 76.0, 80.0, 88.0, 96.0, 104.0, 112.0, 120.0, _
                                     128.0, 136.0, 144.0}
            End Get
        End Property
    End Class
